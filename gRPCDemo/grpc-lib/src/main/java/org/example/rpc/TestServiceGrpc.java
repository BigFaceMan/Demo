...
public final class TestServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<org.example.rpc.ApiIn,
      org.example.rpc.ApiOut> getCheckUserMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "CheckUser",
      requestType = org.example.rpc.ApiIn.class,
      responseType = org.example.rpc.ApiOut.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<org.example.rpc.ApiIn,
      org.example.rpc.ApiOut> getCheckUserMethod() {
    io.grpc.MethodDescriptor<org.example.rpc.ApiIn, org.example.rpc.ApiOut> getCheckUserMethod;
    if ((getCheckUserMethod = TestServiceGrpc.getCheckUserMethod) == null) {
      synchronized (TestServiceGrpc.class) {
        if ((getCheckUserMethod = TestServiceGrpc.getCheckUserMethod) == null) {
          TestServiceGrpc.getCheckUserMethod = getCheckUserMethod =
              io.grpc.MethodDescriptor.<org.example.rpc.ApiIn, org.example.rpc.ApiOut>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "CheckUser"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  org.example.rpc.ApiIn.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  org.example.rpc.ApiOut.getDefaultInstance()))
              .setSchemaDescriptor(new TestServiceMethodDescriptorSupplier("CheckUser"))
              .build();
        }
      }
    }
  ...
  public static abstract class TestServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void checkUser(org.example.rpc.ApiIn request,
        io.grpc.stub.StreamObserver<org.example.rpc.ApiOut> responseObserver) {
      asyncUnimplementedUnaryCall(getCheckUserMethod(), responseObserver);
    }
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                org.example.rpc.ApiIn,
                org.example.rpc.ApiOut>(
                  this, METHODID_CHECK_USER)))
          .build();
    }
  }
  ...
  public static final class TestServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<TestServiceBlockingStub> {
     ...
     * </pre>
     */
    public org.example.rpc.ApiOut checkUser(org.example.rpc.ApiIn request) {
  ...
  public static final class TestServiceFutureStub extends io.grpc.stub.AbstractFutureStub<TestServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<org.example.rpc.ApiOut> checkUser(
        org.example.rpc.ApiIn request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CHECK_USER:
          serviceImpl.checkUser((org.example.rpc.ApiIn) request,
              (io.grpc.stub.StreamObserver<org.example.rpc.ApiOut>) responseObserver);
          break;
        default:
  ...
  private static abstract class TestServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return org.example.rpc.TestServiceOuterClass.getDescriptor();
    }
