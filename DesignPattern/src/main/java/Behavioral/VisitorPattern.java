...
// 圆形类
class VisCircle implements VisShape {
    private double radius;

    public VisCircle(double radius) {
        this.radius = radius;
    }
...
// 矩形类
class Rectangle implements VisShape {
...
public class VisitorPattern {
    public static void main(String[] args) {
        VisCircle circle = new VisCircle(5);
